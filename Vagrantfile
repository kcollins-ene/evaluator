...
wget -q --referer https://inductiveautomation.com/* https://s3.amazonaws.com/files.inductiveautomation.com/release/ia/build7.9.3/20170602-1004/Ignition-7.9.3-linux-x64-installer.run 
>> install.log
